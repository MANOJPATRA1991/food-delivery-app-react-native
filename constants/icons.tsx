...
export const carne = require('../assets/icons/carne.png');
export const chorizo = require('../assets/icons/chorizo.png');
export const entrada = require('../assets/icons/entrada.png');
export const parrilla = require('../assets/icons/Parrilla.png');
export const pescado = require('../assets/icons/pescado.png');
export const piqueos = require('../assets/icons/piqueos.png');
export const postre = require('../assets/icons/postre.png');
export const sopa = require('../assets/icons/sopas.png');
